    ...
    <>
      ...
      <div className='container px-4 min-h-[65vh] 2xl:px-20 mx-auto my-10'>
        ...
        <table className='min-w-full bg-white border rounded-lg'>
          <thead>
            <tr>
              <th className='py-3 border-b px-4 text-left'>Company</th>
              <th className='py-3 border-b px-4 text-left max-sm:hidden'>Job Title</th>
              <th className='py-3 border-b px-4 text-left max-sm:hidden'>Location</th>
              <th className='py-3 border-b px-4 text-left max-sm:hidden'>Date</th>
              <th className='py-3 border-b px-4 text-left max-sm:hidden'>Status</th>
            </tr>
          </thead>
          <tbody>
