...
//         <input min={0} className='w-full px-3 border-2 py-2 border-gray-300 rounded sm:w-[120px]' onChange={e=> setSalary(e.target.value)} type="Number" placeholder='2500' />
//        </div>
...
// this is after chnages made location adn categories
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <input
          min={0}
          className='w-full px-3 border-2 py-2 border-gray-300 rounded sm:w-[120px]'
